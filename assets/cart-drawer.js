class CartDrawer extends HTMLElement {
  ...
  renderContents(parsedState) {
    ...
    setTimeout(() => {
      ...
      this.open();
      this.initUpsellButtons(); // Re-bind upsell buttons
    });
  }
  ...
  /* --- UPSELL LOGIC START --- */
  connectedCallback() {
    // Initialize upsell logic when element connects
    this.initUpsellButtons();
  }

  initUpsellButtons() {
    this.querySelectorAll("[data-origin-cart-upsell-add]").forEach((btn) => {
      ...
      newBtn.addEventListener("click", (e) => {
        ...
        this.addUpsellItem(variantId);
      });
    });
  }

  addUpsellItem(variantId) {
    ...
    fetch(`${routes.cart_add_url}`, { ...fetchConfig(), ...{ body } })
      ...
      .catch(() => {
        ...
        console.error("Error adding upsell item");
      });
  }
  /* --- UPSELL LOGIC END --- */
}
